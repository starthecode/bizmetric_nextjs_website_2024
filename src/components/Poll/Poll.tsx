...
export const Poll = () => {
  ...
  return (
    ...
    >
      <div
        onClick={handlePoll}
        className={`flex rounded-tl-lg rounded-tr-lg justify-center text-center h-fit cursor-pointer shadow-lg shadow-junglegreen-200 border-b border-slate-200/20 bg-white dark:bg-woodsmoke-950 px-1 py-2`}
      >
